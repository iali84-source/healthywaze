...
export const siteSettings = pgTable("site_settings", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  siteName: text("site_name").notNull().default("Your Trusted Family Secrets"),
  ...
  heroHeadline: text("hero_headline").notNull().default("Your Trusted Family Secrets"),
  heroSubheadline: text("hero_subheadline").notNull().default("Discover wellness products trusted by families for generations - Stay energized, focused, and on track"),
  ...
  trustBadgeText: text("trust_badge_text").notNull().default("Your Trusted Family Secrets - 13,000+ Happy Families"),
