...
export const siteSettings = pgTable("site_settings", {
  ...
  heroHeadline: text("hero_headline").notNull().default("Feel Amazing"),
  heroSubheadline: text("hero_subheadline").notNull().default("Your Trusted Family Loving Remedies - Discover wellness products loved and trusted by families for generations"),
