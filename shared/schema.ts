...
export const siteSettings = pgTable("site_settings", {
  ...
  heroHeadline: text("hero_headline").notNull().default("YourTrustedFamilyShop"),
  heroSubheadline: text("hero_subheadline").notNull().default("Your Wellness Journey Made Simple - Powerful products to help you stay energized, focused, and on track"),
  ...
  trustBadgeText: text("trust_badge_text").notNull().default("YourTrustedFamilyShop - 13,000+ Happy Customers"),
